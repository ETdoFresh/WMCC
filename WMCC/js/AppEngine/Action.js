    ...
    Update: function (gameTime) {
        ...
        for (i = this.AlphaValues.length - 1; i >= 0; i--) {
            ...
            this.AlphaValues[i].obj.Alpha =
                this.CalculateValue(a.startValue, a.finishValue, a.startValue, gameTime.TotalTime, a.duration);
        ...
        for (i = this.ScaleValues.length - 1; i >= 0; i--) {
            ...
            this.ScaleValues[i].obj.ScaleX = this.ScaleValues[i].obj.ScaleY =
                this.CalculateValue(s.startValue, s.finishValue, s.startValue, gameTime.TotalTime, s.duration);
